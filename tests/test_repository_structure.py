...
REQUIRED_PATHS = (
    ...
    "scripts/cache_qwen_teacher_tokens.py",
    "scripts/evaluate_qwen_zero_shot.py",
    "scripts/evaluate_qwen_bridge.py",
    "scripts/smoke_test_qwen_bridge.py",
    "scripts/smoke_test_qwen_teacher.py",
    "scripts/train_qwen_bridge.py",
    "scripts/train_qwen_bridge_distillation.py",
    "docs/QWEN_INTEGRATION.md",
    "requirements-qwen.txt",
    "vlm_demo/qwen_bridge_data.py",
    "vlm_demo/qwen_bridge_model.py",
    "vlm_demo/qwen_bridge_training.py",
    "vlm_demo/qwen_distillation.py",
    "vlm_demo/qwen_teacher.py",
    "vlm_demo/qwen_teacher_cache.py",
    "vlm_demo/so400m_encoder.py",
    "vlm_demo/visual_bridge.py",
)
