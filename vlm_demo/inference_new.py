...
class GroundedGIService:
    ...
    def __init__(self) -> None:
        ...
        # It downloads its own encoder + classifier checkpoints from HF
        # when paths are not explicitly provided.
        self.classification_model = load_classifier(device=self.device,)
    ...
    def analyze(
        ...
        with MODEL_LOCK:
            top_predictions, all_scores, classification_seconds = self.classification_model.predict(image)
        ...
        evidence = {
            ...
            "classification": {
                ...
                "model": "two_stage_siglip2_swin_classifier",
                "checkpoint": "Lian70/classifier",
            },
